/* Editted by Devin Huyghebaert Nov. 3, 2016 */
...
double inclination_global,declination_global;
...
strncpy(mdfile,file_in,MAXREAD);
stream=fopen(mdfile, "rt");
	...
	inclination_global = i;
	declination_global = d;
